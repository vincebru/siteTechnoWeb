...
include_once 'action/admin/DeleteUser.php';
include_once 'action/admin/UpdatePasswordUser.php';
...
include_once 'action/ajax/Get.php';
...
include_once 'view/administration/AdminUpdatePasswordView.php';
