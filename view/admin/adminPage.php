		...
		<div class="row pl-3">
			<div class="col-3 bg-light"> 
				<nav id='summary' class="navbar navbar-light flex-column">
					<span class="navbar-brand">
						...
						<button type="button" class="btn btn-outline-primary btn-sm" data-toggle="modal" data-target="#addPageModal">
			...
			<div class="col-9">
				<div data-spy="scroll" data-target="#summary" data-offset="0" class="lessonEdition">
					...
					<button type="button" class="btn btn-outline-primary btn-sm float-right" data-toggle="modal" data-target="#editPageModal">
						<i class="fa fa-edit"></i>
					</button>
					<p class="float-none"><?php echo $page->getCode(); ?></p>
					<?php }?>
				</div>
			</div>
		</div>
